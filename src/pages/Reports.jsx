  ...
  return (
    <div className="p-4 space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className={`rounded-xl border p-4 shadow-sm ${diff > 0 ? "bg-red-50 border-red-100" : diff < 0 ? "bg-green-50 border-green-100" : "bg-white border-border"}`}>
      ...
      {chartData.length > 0 ? (
        ...
        <div className="bg-white rounded-xl border border-border p-8 shadow-sm text-center text-muted-foreground">
